  ...
  const variants = [
    {
      ...
      estimated_cost_usd: 0.28625,
      estimated_cost_usd_all_input_uncached: 0.325,
      rate_snapshot_usd_per_million: {
        input: 2.5,
        cached_input: 0.25,
        cache_write: 3.125,
    ...
    },
    {
      ...
      estimated_cost_usd_all_input_uncached: 0.13,
      rate_snapshot_usd_per_million: {
        input: 1,
        cached_input: 0.1,
        cache_write: 1.25,
...
test("accepts the processor's half-up eight-decimal cost rounding", () => {
  assert.equal(
    parseTakeoffProcessorUsage({
      ...
      estimated_cost_usd: 0.00000313,
      estimated_cost_usd_all_input_uncached: 0.0000025,
      rate_snapshot_usd_per_million: {
        input: 2.5,
        cached_input: 0.25,
        cache_write: 3.125,
